		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','age') || $check_field('add','age') || $check_field('set','age')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="年龄" prop="age">
					<el-input id="age" v-model="form_sub['age']" placeholder="请输入年龄"
							  v-if="user_group === '管理员' || (form_sub['ordinary_users_id'] && $check_field('set','age')) || (!form_sub['ordinary_users_id'] && $check_field('add','age'))"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','id') || $check_field('add','id') || $check_field('set','id')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="身份证" prop="id">
					<el-input id="id" v-model="form_sub['id']" placeholder="请输入身份证"
							  v-if="user_group === '管理员' || (form_sub['ordinary_users_id'] && $check_field('set','id')) || (!form_sub['ordinary_users_id'] && $check_field('add','id'))"></el-input>
					<div v-else-if="$check_field('get','id')">{{form_sub['id']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','community') || $check_field('add','community') || $check_field('set','community')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="社区" prop="community">
					<el-input id="community" v-model="form_sub['community']" placeholder="请输入社区"
							  v-if="user_group === '管理员' || (form_sub['ordinary_users_id'] && $check_field('set','community')) || (!form_sub['ordinary_users_id'] && $check_field('add','community'))"></el-input>
					<div v-else-if="$check_field('get','community')">{{form_sub['community']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','unit') || $check_field('add','unit') || $check_field('set','unit')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="单元" prop="unit">
					<el-input id="unit" v-model="form_sub['unit']" placeholder="请输入单元"
							  v-if="user_group === '管理员' || (form_sub['ordinary_users_id'] && $check_field('set','unit')) || (!form_sub['ordinary_users_id'] && $check_field('add','unit'))"></el-input>
					<div v-else-if="$check_field('get','unit')">{{form_sub['unit']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','floor') || $check_field('add','floor') || $check_field('set','floor')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="楼层" prop="floor">
					<el-input id="floor" v-model="form_sub['floor']" placeholder="请输入楼层"
							  v-if="user_group === '管理员' || (form_sub['ordinary_users_id'] && $check_field('set','floor')) || (!form_sub['ordinary_users_id'] && $check_field('add','floor'))"></el-input>
					<div v-else-if="$check_field('get','floor')">{{form_sub['floor']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','house_number') || $check_field('add','house_number') || $check_field('set','house_number')" :xs="24" :sm="12" :lg="8">
				<el-form-item label="门牌号" prop="house_number">
					<el-input id="house_number" v-model="form_sub['house_number']" placeholder="请输入门牌号"
							  v-if="user_group === '管理员' || (form_sub['ordinary_users_id'] && $check_field('set','house_number')) || (!form_sub['ordinary_users_id'] && $check_field('add','house_number'))"></el-input>
					<div v-else-if="$check_field('get','house_number')">{{form_sub['house_number']}}</div>
				</el-form-item>
			</el-col>
			<el-col :xs="24" :sm="12" :lg="8">
				<el-form-item>
		...
		data() {
			return {
				...
				disabledObj:{
					...
					"unit_isDisabled": false,
					"floor_isDisabled": false,
					"house_number_isDisabled": false,
				},
